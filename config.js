...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SILENT-SOBX-MD~HJo0QaBD#f9dcYD0GlxiTvSFiEL0lv4DmS5yhnEpmNo62gDo3sS0",
    CAPTION: process.env.CAPTION || "POWERED BY MR.SAHAS",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M MR.SAHAS MD WHATSAPP BOT 😊♻️",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү MR.S A H A S`",
